...
Zwei Tatverdächtige mit den Namen A, B beschuldigen sich gegenseitig. Folgende Aussagen konnten ermittelt werden:
\begin{enumerate}
	\item Person A sagt, Person B sei Täter.
	\item Person B sagt, wenn sie Täter ist, dann sei auch A Täter.
